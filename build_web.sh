...
flags="-sUSE_GLFW=3 -sWASM_BIGINT -sINITIAL_MEMORY=536870912 -sWARN_ON_UNDEFINED_SYMBOLS=0 -sASSERTIONS --shell-file source/main_web/index_template.html --preload-file assets"
